...
**Frequently used:** Python, C++, TypeScript, React, Next.js, FastAPI, PyTorch, Docker, Linux, GitHub Actions.
...
|---|---|---|
| Blog / Nova Theme | Personal Hexo blog with dark mode, code highlighting, MathJax and visual effects | [Visit](https://liangqianxing.github.io) |
| DeepScientist | AI-powered research management platform | [Website](https://deepscientist.cc) |
| MiniCode | Lightweight terminal AI coding assistant with Claude Code-style workflow | [GitHub](https://github.com/LiuMengxuan04/MiniCode) |
...
<sub>Built with ❤️ · More notes at <a href="https://liangqianxing.github.io">liangqianxing.github.io</a></sub>
